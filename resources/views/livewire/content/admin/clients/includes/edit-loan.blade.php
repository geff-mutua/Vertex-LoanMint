<div wire:ignore.self class="modal fade" id="editLoan{{ $value->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel4">Edit Loan</h5>
                ...
                <form >
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-outline">
                                <input wire:click="setLoanDetails" type="number" class="form-control"
                                    wire:model="individual_loan_amount" placeholder="Enter Amount" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-outline">
                                <select wire:click="setLoanDetails" class="form-control" wire:model="loan_product"
                                    id="">
                        ...
                        @if ($loan_product != '')
                            ...
                            <div class=" d-flex justify-content-end pt-3">
                                <button wire:click="updateLoan" class="btn btn-primary" type="button">
                                    <div wire:loading wire:target="updateLoan">

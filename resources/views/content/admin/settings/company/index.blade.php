...
@section('content')
    <div class="card">
        ...
        <div class="card-body justify-content-center mt-1">
            ...
            <form action="{{ route('company-update', ['domain' => auth()->user()->domain->name]) }}" method="post"
                ...
                <div class="row">
                    @if (!is_null($settings))
                        @if (!is_null($settings->logo))
                            <div>
                                <img src="{{ asset('logo/' . $settings->logo) }}" width="200" height="150"
                                    alt="">
                            </div>
                        @endif
                    @endif
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input placeholder="Company Name" type="text" class="form-control" name="name"
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="text" placeholder="Official Email" class="form-control" name="email"
                    ...
                    <div class="form-group col-md-6 mb-3 ">
                        ...
                        <input type="number" name="mobile" class="form-control"
                            value="{{ $settings ? $settings->mobile : '' }}" placeholder="Mobile Number">
                        @error('mobile')
                            <small style="font-size: 10px" class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <select name="country" class="form-control" id="">
                            <option value="{{ $settings ? $settings->country : '' }}">{{ $settings ? $settings->country : '' }}
                            </option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" readonly disabled class="form-control"
                            value="{{ auth()->user()->domain->name }}.loan-mint.com" placeholder="Company Domain">
